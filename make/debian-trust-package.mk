...
$(debian_package_json): | $(bin_dir)/bin/validate-trust-package $(debian_package_layer)/debian-package
	BIN_VALIDATE_TRUST_PACKAGE=$(bin_dir)/bin/validate-trust-package \
		./make/debian-trust-package-fetch.sh $(DEBIAN_BUNDLE_SOURCE_IMAGE) $@ $(DEBIAN_BUNDLE_VERSION)
...
upgrade-debian-trust-package-version: |
	...
	BIN_VALIDATE_TRUST_PACKAGE=$(bin_dir)/bin/validate-trust-package \
		./make/debian-trust-package-fetch.sh $(DEBIAN_BUNDLE_SOURCE_IMAGE) $(temp_out)
